    ...
    return (
        <div className='flex items-center justify-between bg-gradient-to-l from-[#6c63ff] via-[#3E58A9] to-[#3E58A9] px-4 py-3 text-white'>
            <div className='flex items-center space-x-3'>
                ...
                <img src={currentUser.photoURL} alt="users" className='w-12 h-12 p-[1px] object-cover rounded-full border-2 border-emerald-400' />
                <div>
                    <h2 className='text-lg'>{currentUser.displayName}</h2>
