      ...
      <div className={`flex ${message.senderId === currentUser.uid ? 'justify-end' : 'justify-start'} gap-2`} ref={ref}>
        ...
        {message.senderId === currentUser.uid ? (
          <>
            ...
            <div className="p-2 mt-5 max-w-[80%] break-words bg-gradient-to-l from-[#6c63ff] via-[#6c63ff] to-[#3E58A9] text-white shadow-lg rounded-tl-[0.4rem] rounded-bl-[0.4rem] rounded-br-[1rem]">
          ...
          <>
            ...
            />
            <div className="p-2 mt-5 max-w-[80%] break-words bg-white text-black shadow-lg rounded-bl-[1rem] rounded-br-[0.4rem] rounded-tr-[0.4rem]">
              <p className="">{message.text}</p>
            </div>
            {/* <span className="text-xs mt-8 text-gray-400 font-bold">{formatDate(message.date)}</span> */}
          </>
