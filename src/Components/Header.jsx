...
const Header = () => {
  return (
    <div className='bg-gray-50 p-4 space-y-4 shadow-md'>
      <div className='flex items-center justify-between'>
        <h1 className='text-2xl font-bold text-gray-900'>ChatHub</h1>
      ...
      <div className='flex items-center space-x-2'>
        <input type="text" placeholder='Search' className='w-full px-4 py-1 bg-white rounded-full outline-none border border-gray-800 focus:ring-1' />
        <p className='bg-blue-400 w-10 h-9 text-center rounded-full text-white cursor-pointer'>+</p>
      </div>
    </div>
  )
}
